...
void door_status(void)
{
    if(RB3 == 0)
    {
        ...
        RC1 = 1;
        clear_screen();
        clcd_print("DOOR is Open",(0xC0 + 0));
...
void set_temp(unsigned char key, int reset_flag)
{
    ...
    if(reset_flag == 0x10)
    {
        ...
        clcd_putch(0xDF, (0x80 + 10));
        clcd_print("TEMP = ", (0xC0 + 0));
        clcd_print("(LIMIT : 180 C) ", (0x90 + 0));
        clcd_putch(0xDF, (0x90 + 12));
    ...
    else if(key == '#')
    {
        ...
        {
            clear_screen();
            clcd_print("  Temp. Invalid  ", (0xC0 + 0));
            _delay((unsigned long)((2000)*(20000000/4000.0)));
            clear_screen();
            operation_flag = 0x02;
        }
        ...
        if(sec == 0)
        {
           flag = 1;
           clear_screen();
           clcd_print("  Set the Time  ", (0xC0 + 0));
           RC1 = 1;
           _delay((unsigned long)((3000)*(20000000/4000.0)));
           clear_screen();
           RC2 = 0;
